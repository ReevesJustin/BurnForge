...
## Behavior
- After any major task completion (code changes, fitting runs, diagnostics, tests), automatically generate and write an updated summary to the project root file status-summary.md.
- Overwrite status-summary.md each time with the latest full status (do not append).
